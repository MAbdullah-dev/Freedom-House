<div class="about-us">
    <section class="about-us-main" style="background-image: url('{{ asset('assets/images/Section.png') }}');">
        <div class="container">
    ...
    <section class="training-team-section">
        <div class="container">
            ...
            <div class="card-container">
                <div class="card">
                    <img src="{{ asset('assets/images/Rectangle 5524.png') }}" alt=""
                ...
                <div class="card">
                    <img src="{{ asset('assets/images/image (1).png') }}" alt="" class="card-img-top img-fluid">
                    <div class="card-body text-center">
                        <h5>Autumn Green</h5>
                        <span>Behavioral Health Trainer</span>
                        <p>Autumn has worked as a mental health clinician for over 3 years. She began her career within
                ...
                <div class="card">
                    <img src="{{ asset('assets/images/image.png') }}" alt="" class="card-img-top img-fluid">
                    <div class="card-body text-center">
                        <h5>Autumn Green</h5>
                        <span>Behavioral Health Trainer</span>
                        <p>Autumn has worked as a mental health clinician for over 3 years. She began her career within
                ...
                <div class="card">
                    <img src="{{ asset('assets/images/image (2).png') }}" alt="" class="card-img-top img-fluid">
                    <div class="card-body text-center">
                        <h5>Autumn Green</h5>
                        <span>Behavioral Health Trainer</span>
                        <p>Autumn has worked as a mental health clinician for over 3 years. She began her career within
